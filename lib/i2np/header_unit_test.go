...
func TestCrasherRegression123781(t *testing.T) {
	// Fuzz test regression - verify this doesn't crash
	_, _ = ReadI2NPNTCPHeader([]byte{0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x00, 0x00, 0x30})
}
