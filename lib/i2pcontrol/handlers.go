...
func (h *RouterInfoHandler) buildAvailableFields() map[string]interface{} {
	...
	fields := map[string]interface{}{
		...
		"i2p.router.netdb.routerinfo.rejected.datatype":   routerStats.RouterInfoRejectDataTypeCount,
		"i2p.router.netdb.routerinfo.rejected.parse":      routerStats.RouterInfoRejectParseCount,
		"i2p.router.netdb.routerinfo.rejected.validation": routerStats.RouterInfoRejectValidationCount,
		"i2p.router.netdb.routerinfo.rejected.hash":       routerStats.RouterInfoRejectHashCount,
		"i2p.router.netdb.routerinfo.rejected.signature":  routerStats.RouterInfoRejectSignatureCount,
		"i2p.router.netdb.routerinfo.rejected.network":    routerStats.RouterInfoRejectNetworkCount,
		"i2p.router.netdb.routerinfo.rejected.admission":  routerStats.RouterInfoRejectAdmissionCount,
	...
	if localHash, err := h.stats.GetLocalRouterIdentityHash(); err == nil {
		fields["i2p.router.hash"] = localHash
	} else {
