...
The I2P community maintains up-to-date [specifications](https://geti2p.net/spec) of most of the application, which are being used to create go-i2p.  Currently, most of the common data structures (located in `github.com/go-i2p/common`, the contemporary, non-experimental cryptography (located in `github.com/go-i2p/crypto` and `github.com/go-i2p/go-noise`)) have been implemented and tested, and serve as good examples.
